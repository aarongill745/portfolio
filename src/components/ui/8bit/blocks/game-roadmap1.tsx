...
const statusConfig = {
  completed: { badge: "COMPLETED", variant: "default" as const },
        ...
        <div className="relative">
          ...
          <div className="flex flex-col gap-4">
            {quests.map((quest) => {
              ...
              const isDimmed = quest.status === "completed";
                  ...
                  >
                    <CardHeader className="pb-2">
                      <div className="flex items-center gap-4">
                        ...
                        <Badge variant={config.variant} className="retro text-[9px]">{config.badge}</Badge>
                      </div>
                    </CardHeader>
                    <CardContent>
